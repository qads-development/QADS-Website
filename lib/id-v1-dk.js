(function(window, document) {
    ...
    const CONFIG = {
        iframeSrc: 'https://qads.cloud/id-dark-frame.html', 
    ...
    function init() {
        console.log('QADS Security: Initializing...');

        const container = document.getElementById(CONFIG.containerId);
        if (!container) {
            console.warn('QADS Security: Container element #' + CONFIG.containerId + ' not found.');
            return;
        }

        targetForm = container.closest('form');
        if (!targetForm) {
            console.error('QADS Security: Widget must be placed inside a <form> tag.');
            return;
        }
    ...
    function injectWidget(container) {
        ...
        widgetIframe.title = "QADS Security Verification";
    ...
    function unlockForm(token) {
        ...
        console.log('QADS Security: Access Granted.');
    }
